# Bloodbound Curse‑Warden

_Ancient • Relentless • Bound by Malediction_
...
- Stands motionless for decades until disturbed.
- Tracks intruders with slow, deliberate precision.
- Reacts violently to fire, as if remembering an ancient wound.
- Shows no mercy, hesitation, or emotion — only purpose.
- Smashes obstacles with the same intent it uses on enemies.
...
- Becomes dangerously unstable when heavily damaged.
- Ignores distractions, illusions, and pleas for mercy.
- Continues fighting until destroyed or commanded to stand down.
